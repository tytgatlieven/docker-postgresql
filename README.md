# sameersbn/postgresql:17-20260107
...
```bash
docker pull sameersbn/postgresql:17-20260107
```
...
```bash
docker run --name postgresql -itd --restart always \
  sameersbn/postgresql:17-20260107 -c log_connections=on
```
...
```bash
docker run --name postgresql -itd --restart always \
  sameersbn/postgresql:17-20260107 -c logging_collector=on
```
